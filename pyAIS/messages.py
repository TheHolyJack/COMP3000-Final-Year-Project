...
class MessageType1(Payload, CommunicationStateMixin):
    ...
    sig = bit_field(1600, bytes, default=b'', signed=False) # MODIFICATION HERE
...
@attr.s(slots=True)
class MessageType28(Payload, CommunicationStateMixin):
    """
    Cryptographically signed version of MessageType1
